...
const MultiSelectFilterTest = () => {
    return (
        <>
        <p>hi!</p>
        <select multiple={true} data-hs-select='{
            ...
            <option selected={true} value="1" data-hs-select-option='{
                "description": "chris",
            ...
            <option value="3" disabled={true} data-hs-select-option='{
                "description": "alex27",
...
export default MultiSelectFilterTest;